...
def test_activar_tnt(minecraft_data):
    ...
    result = server.enableBot(player_list[0], 'TNT')
...
def test_activar_ai(minecraft_data):
    mc, player_list = minecraft_data
    result = server.enableBot(player_list[0], 'ChatAI')
    assert result is None

def test_activar_insult(minecraft_data):
    mc, player_list = minecraft_data
    result = server.enableBot(player_list[0], 'Insult')
    assert result is None

def test_desactivar_tnt(minecraft_data):
    mc, player_list = minecraft_data
    result = server.disableBot(player_list[0], 'TNT')
    assert result is None
...
def test_desactivar_ai(minecraft_data):
    ...
    time.sleep(2)
    result = server.disableBot(player_list[0], 'ChatAI')
    assert result is None
...
def test_desactivar_insult(minecraft_data):
    ...
    time.sleep(2)
    result = server.disableBot(player_list[0], 'Insult')
    assert result is None
